...
func NewMigrateDataTrieFunc(
	...
	mdt.baseActiveHandler.activeHandler = enableEpochsHandler.IsAutoBalanceDataTriesEnabledInEpoch
	mdt.baseActiveHandler.currentEpochHandler = enableEpochsHandler.GetCurrentEpoch
