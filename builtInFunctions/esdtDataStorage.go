...
func (e *esdtDataStorage) getESDTNFTTokenOnDestinationWithAccountsAdapterOptions(
	...
	if !e.enableEpochsHandler.IsFlagEnabledInCurrentEpoch(core.SaveToSystemAccountFlag) || nonce == 0 {
...
func (e *esdtDataStorage) checkCollectionIsFrozenForAccount(
	...
	if !e.enableEpochsHandler.IsFlagEnabledInCurrentEpoch(core.CheckFrozenCollectionFlag) {
		return nil
	}
...
func (e *esdtDataStorage) AddToLiquiditySystemAcc(
	...
	isSaveToSystemAccountFlagEnabled := e.enableEpochsHandler.IsFlagEnabledInCurrentEpoch(core.SaveToSystemAccountFlag)
	isSendAlwaysFlagEnabled := e.enableEpochsHandler.IsFlagEnabledInCurrentEpoch(core.SendAlwaysFlag)
	...
	if e.enableEpochsHandler.IsFlagEnabledInCurrentEpoch(core.FixOldTokenLiquidityFlag) {
...
func (e *esdtDataStorage) SaveESDTNFTToken(
	...
	if e.enableEpochsHandler.IsFlagEnabledInCurrentEpoch(core.SaveToSystemAccountFlag) {
...
func (e *esdtDataStorage) saveMetadataIfRequired(
	...
	if !e.enableEpochsHandler.IsFlagEnabledInCurrentEpoch(core.AlwaysSaveTokenMetaDataFlag) {
		return nil
	}
	if !e.enableEpochsHandler.IsFlagEnabledInCurrentEpoch(core.SendAlwaysFlag) {
