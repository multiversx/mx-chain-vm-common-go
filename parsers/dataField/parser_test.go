...
func createMockArgumentsOperationParser() *ArgsOperationDataFieldParser {
	return &ArgsOperationDataFieldParser{
		...
		AddressLength:                       32,
		RelayedTransactionsV1V2DisableEpoch: 100,
	}
}
...
func TestParseQuantityOperationsESDT(t *testing.T) {
	...
	t.Run("ESDTLocalBurn", func(t *testing.T) {
		...
		res := parser.Parse(dataField, sender, sender, 3, 0)
...
func TestParseBlockingOperationESDT(t *testing.T) {
	...
	t.Run("ESDTFreeze", func(t *testing.T) {
		...
		res := parser.Parse(dataField, sender, receiver, 3, 0)
		require.Equal(t, &ResponseParseData{
	...
	t.Run("SCCall", func(t *testing.T) {
		...
		res := parser.Parse(dataField, sender, receiverSC, 3, 0)
		require.Equal(t, &ResponseParseData{
...
func TestOperationDataFieldParser_ParseRelayed(t *testing.T) {
	...
	t.Run("relayed disabled should return empty response data", func(t *testing.T) {
		t.Parallel()
		...
		disableEpoch := uint32(5)
		localArgs := createMockArgumentsOperationParser()
		localArgs.RelayedTransactionsV1V2DisableEpoch = disableEpoch
		localParser, _ := NewOperationDataFieldParser(localArgs)
		res := localParser.Parse(dataField, sender, receiver, 3, disableEpoch)
...
func TestParseSCDeploy(t *testing.T) {
	...
	t.Run("ScDeploy", func(t *testing.T) {
		...
		res := parser.Parse(dataField, sender, rcvAddr, 3, 0)
		require.Equal(t, &ResponseParseData{
