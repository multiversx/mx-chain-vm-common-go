...
func TestNewDataTrieMigrator(t *testing.T) {
	...
	t.Run("gas provided is not enough", func(t *testing.T) {
		...
		dtm, err := NewDataTrieMigrator(5, vmcommon.BuiltInCost{TrieLoad: 10})
	...
	t.Run("should work", func(t *testing.T) {
		...
		dtm, err := NewDataTrieMigrator(10, vmcommon.BuiltInCost{TrieLoad: 5})
		assert.Nil(t, err)
...
func TestConsumeStorageLoadGas(t *testing.T) {
	...
	dtm, _ := NewDataTrieMigrator(15, vmcommon.BuiltInCost{TrieLoad: 6})
...
func TestAddLeafToMigrationQueue(t *testing.T) {
	...
	t.Run("migrate to NotSpecified", func(t *testing.T) {
		...
		dtm, _ := NewDataTrieMigrator(15, vmcommon.BuiltInCost{TrieStore: 5})
	...
	t.Run("migrate consumes gas", func(t *testing.T) {
		...
		dtm, _ := NewDataTrieMigrator(11, vmcommon.BuiltInCost{TrieStore: 5})
